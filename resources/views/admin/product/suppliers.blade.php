                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($manufacturers as $manufacturer)
                                    ...
                                    <tr data-id="{{$manufacturer -> id}}">
                                        ...
                                        <td><a class="remove__product" href="{{url('/suppliers_delete/'.$manufacturer -> id)}}"><i class="table--icons ti-trash type-success" aria-label="Try me! Example: success modal" data-toggle="tooltip" title="Удалить"></i></a><a href="{{url('/suppliers_edit/'.$manufacturer -> id)}}"><i class="table--icons ti-pencil-alt" data-toggle="tooltip" title="Редактировать"></i></a> </td>
                                    </tr>
