<?php
$config['smtp_username'] = 'web@gost.city'; // smtp username
$config['smtp_port'] = '465'; // smtp port
$config['smtp_host'] = 'mail.gost.city'; // smtp server
$config['smtp_password'] = 'KP!5_gUi'; // password
$config['smtp_charset'] = 'utf-8'; // encoding, usually utf-8
$config['smtp_from'] = 'GOST'; // sender name
